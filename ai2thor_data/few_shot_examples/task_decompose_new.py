# TASK DESCIPTION: Put an Egg in the Fridge, and place a pot containing Apple slices into the refrigerator.
...
# TASK DESCIPTION: cook an egg then put it back inside the fridge and chill the bread from the counter then put it on the counter.
...
# TASK DESCIPTION: Make a sandwich with sliced lettuce, sliced tomato, sliced bread and serve it on a washed plate.
...
# TASK DESCIPTION: fry the potato.
